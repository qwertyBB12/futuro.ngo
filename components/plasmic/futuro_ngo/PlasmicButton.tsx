...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 0xgMYo2lU1H9/css

import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: zGKoqT_EIsP0/icon
import ChevronDown2Icon from "./icons/PlasmicIcon__ChevronDown2"; // plasmic-import: lLb_pGkBelos/icon
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    <BaseButton
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_garnet]: hasVariant($state, "color", "garnet"),
          ...
          [sty.rootcolor_slateD0]: hasVariant($state, "color", "slateD0"),
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__m1Wqr, {
          [sty.freeBoxcolor_neutral__m1Wqrtf3Cc]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_white__m1WqrFcCyl]: hasVariant(
            $state,
            "color",
            "white"
          ),
          [sty.freeBoxroundedFull__m1WqrptXCu]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__m1Wqr5X50]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__m1WqrffJaR]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__m1Wqr1NzyL]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__m1WqrU4Kb3]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__m1WqrXLszb]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__m1WqrXLszbZ7O0]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__y37H2, {
            [sty.freeBoxcolor_neutral__y37H2Tf3Cc]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__y37H2B9QH9]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__y37H25X50]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__y37H21NzyL]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__y37H2U4Kb3]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__y37H2XLszb]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__y37H2Ox754Tf3Cc]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__e99GE)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__vCrH, {
            [sty.freeBoxiconEnd__vCrHC4DYg]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__vCrH5X50]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__vCrH1NzyL]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__vCrHU4Kb3]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDown2Icon
                className={classNames(projectcss.all, sty.svg__dMqWh)}
                role={"img"}
              />
            ),
      ...
      <div
        ...
        className={classNames(projectcss.all, projectcss.__wab_text, sty.text, {
          [sty.texttype_soft]: hasVariant($state, "type", "soft")
        })}
      >
        {"Enter some text"}
      </div>
