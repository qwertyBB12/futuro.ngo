...
import Label from "../../Label"; // plasmic-import: QmhthqFvUUHE/component
import Checkbox from "../../Checkbox"; // plasmic-import: 0zQ1JXF_mQxr/component
import Description from "../../Description"; // plasmic-import: 21LyPaVEEBlD/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: A1vHSB5G9NoX/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__bebTc)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__kns6Y)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__i6Sbj)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__rs8N)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
