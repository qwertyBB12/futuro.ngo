...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: 0zQ1JXF_mQxr/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: aq-qCxRAZjkn/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: 96iEvyTAXUYu/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__dvM3A)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__gt2T1)}
            role={"img"}
          />
        ) : null}
      </div>
